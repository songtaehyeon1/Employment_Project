$(function() {
	...
	$("input[name='qcservicetype']").click(function() {

		var cnt = $("input[name='qcservicetype']:checked").length;
		if (cnt > 3) {
			alert("선택은 3개까지 가능합니다.");
			$(this).prop("checked", false);
		}
	...
	$("input[name='rpregisterway']").click(function() {
		recruittypechk();
	});
	...
	$("#addgenderage").click(function() {
		$("#gender_age_content").toggle("fast", function() {
			if ($("#gender_age_content").css("display") == "none") {
				...
				$("#select_sex").attr("name","qcgender");
				$("#select_age").attr("name","qcage");
			} else if ($("#gender_age_content").css("display") != "none") {
				$("#addgenderage").html("성별,연령 추가입력△");
				$("#select_sex").attr("name","");
				$("#select_age").attr("name","");
			}
		});
	...
	$("#paper_save").click(function() {
		...
		$("#paper_title").html(a);
		$("#rpdocumentscreening").attr("value",a);
	});
	...
	$("#interview_save").click(function() {
		...
		$("#rpprimaryinterview").attr("value",a);
	});
	$("#interview_save2").click(function() {
		...
		$("#rpsecondaryinterview").attr("value",a);
	});
