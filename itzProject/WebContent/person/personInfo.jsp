...
<div class="container">
	<h2>회원정보 수정</h2>
	<p><small>회원님의 정보를 수정·확인하실 수 있습니다.</small></p>

	<div class="content">
		<form method="post" id="personInfoFrm" action="<%=ctx%>/person/personInfoEditOk.do">
			<div class="form-group">
				<label for="person_eamil" class="lbl_email">이메일(아이디)</label> 
				<div><strong>${vo.person_email}</strong></div>
			</div>
	
			<div class="form-group">
				<label for="pwd">비밀번호</label> 
				<input type="password" class="form-control" id="pwd" placeholder="6~16자의 영문 대소문자, 숫자, 특수문자 중 2가지 이상 조합" name="pswd" maxlength="20">
			</div>
			<div class="form-group">
